...
import { SubscriptionFilters } from "./partner-subscriptions/SubscriptionFilters";
import { SubscriptionTableRow } from "./partner-subscriptions/SubscriptionTableRow";
import { mockSubscriptions } from "./partner-subscriptions/mockSubscriptions";

type SubscriptionStatus = "active" | "trialing" | "past_due" | "canceled";

export function PartnerSubscriptionsView() {
  ...
  const handleExport = () => {
    setIsExporting(true);
    setTimeout(() => {
      console.log("Exporting Partner subscription data...");
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight">Partner Subscriptions</h1>
          </div>
          <p className="text-muted-foreground mt-1">
            Manage Partner optional subscription plans and billing
          </p>
        </div>
